...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The IRIS dataset is a popular dataset commonly used for exploring data analysis and data visualisation. Used first by R.A. Fisher in 1936 to showcase a "then new technique of linear discriminant analysis"[^] offering a more accurate alternative to the common k-means clustering[^].  
...
While there are some who question the use of the dataset, due to its simplicity and the absence of imperfect entries, it is easy to see why it has stood the test of time, the simplicity which some critic others praise [^].  This simplicity of the dataset paired with the endless resources available online, makes it a great starting point for anyone dipping their toes in the world of data analysis to gain insights into tools used for analysis using the relatively simple set of data.
...
> `.hist` - creates histogram to represent distribution of values for a variable in the dataset[^]. Within *analysis.py* stacking functionality is used for the histograms to show the data colour coded per class of Iris[^].
...
[^3]: Unwin, A. and Kleinman, K. (2021) ‘The iris data set: In search of the source of virginica’, Significance, 18(6), pp. 1-2. doi:10.1111/1740-9713.01589.  
...
[^22]: https://matplotlib.org/stable/api/_as_gen/matplotlib.patches.Ellipse.html#matplotlib-patches-ellipse  
[^23]: https://matplotlib.org/stable/gallery/statistics/confidence_ellipse.html#sphx-glr-gallery-statistics-confidence-ellipse-py  
[^24]: https://www.datacamp.com/tutorial/python-numpy-tutorial  
[^25]: https://realpython.com/np-linspace-numpy/   
[^26]: https://www.analyticsvidhya.com/blog/2023/12/mastering-tabulate/   
[^27]: https://docs.python.org/3/library/os.html   
[^28]: https://www.freecodecamp.org/news/how-to-check-if-a-file-exists-in-python/   
[^29]: https://www.simplilearn.com/tutorials/python-tutorial/enumerate-in-python#what_does_enumerate_do_in_python  
